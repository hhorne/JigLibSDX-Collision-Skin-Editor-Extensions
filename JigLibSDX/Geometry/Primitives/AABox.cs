...
/*
        ...
        public void AddCapsule(Capsule capsule)
        {
            ...
            AddSphere(new Sphere(capsule.Position + capsule.Length * MatrixHelper.Backward(capsule.Orientation), capsule.Radius));
        }
...
*/
        ...
        {
            // todo implement
            // throw new JigLibSDXException("Not implemented!");
    ...
    public class BoundingBoxHelper
    {
        ...
        static public void AddSphere(SlimDX.BoundingSphere sphere, ref BoundingBox bb)
        {
            Vector3 radius = new Vector3(sphere.Radius);
        ...
        {
            AddSphere(new SlimDX.BoundingSphere(capsule.Position, capsule.Radius), ref bb);
            AddSphere(new SlimDX.BoundingSphere(capsule.Position + capsule.Length * MatrixHelper.GetBackward(capsule.Orientation), capsule.Radius), ref bb);
        }
