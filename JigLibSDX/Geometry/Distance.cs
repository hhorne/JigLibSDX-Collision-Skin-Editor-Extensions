...
namespace JigLibSDX.Geometry
{
    ...
    public sealed class Distance
    {
        ...
        {
            float num0 = Vector3.Dot(plane.normal, pt);
            return plane.D + num0;
        }
        ...
        public static float PointSegmentDistanceSq(out float t, Vector3 pt, Segment seg)
        {
            ...
            fT = Vector3.Dot(kDiff, seg.Delta);
            ...
            out float pfBParam0, out float pfBParam1, out float pfBParam2)
        {
            ...
            Vector3 kClosest = new Vector3(Vector3.Dot(kDiff, MatrixHelper.GetRight(box.Orientation)),
                              Vector3.Dot(kDiff, MatrixHelper.GetUp(box.Orientation)),
                              Vector3.Dot(kDiff, MatrixHelper.GetBackward(box.Orientation)));
            ...
            out float pfBParam0, out float pfBParam1, out float pfBParam2)
        {
            ...
            Matrix boxOrientation = box.Orientation;

            Vector3 diff = line.Origin - box.GetCentre();
            Vector3 pnt = new Vector3(Vector3.Dot(diff, MatrixHelper.GetRight(ref boxOrientation)),
                Vector3.Dot(diff, MatrixHelper.GetUp(ref boxOrientation)),
                Vector3.Dot(diff, MatrixHelper.GetBackward(ref boxOrientation)));
            Vector3 kDir = new Vector3(Vector3.Dot(line.Dir, MatrixHelper.GetRight(ref boxOrientation)),
                Vector3.Dot(line.Dir, MatrixHelper.GetUp(ref boxOrientation)),
                 Vector3.Dot(line.Dir, MatrixHelper.GetBackward(ref boxOrientation)));
        ...
        /// <param name="t1">Parametric representation of nearest point on seg1.</param>
