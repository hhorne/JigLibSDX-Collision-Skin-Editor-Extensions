...
namespace JigLibSDX.Physics
{
    ...
    public partial class Body
    {
        ...
        public void UpdateVelocity(float dt)
        {
            ...
            #region REFERENCE: transformRate.AngularVelocity += Vector3.TransformCoordinate(torque * dt, worldInvInertia);
            Vector3 angVel;
            Vector3.Multiply(ref torque, dt, out angVel);
            Vector3.TransformCoordinate(ref angVel, ref worldInvInertia, out angVel);
        ...
        public void UpdatePosition(float dt)
        {
            ...
            #region REFERENCE: transformRate.AngularVelocity = Vector3.TransformCoordinate(angMomBefore, worldInvInertia);
        ...
        public void ApplyWorldImpulse(ref Vector3 impulse,ref Vector3 pos)
        {
            ...
            Vector3.TransformCoordinate(ref v1, ref worldInvInertia, out v1);
        ...
        {
            if (immovable) return;
            Vector3.TransformCoordinate(ref angImpulse, ref worldInvInertia, out angImpulse);
        ...
        public void ApplyBodyWorldImpulse(ref Vector3 impulse,ref Vector3 delta)
        {
            ...
            #region INLINE: transformRate.AngularVelocity += Vector3.TransformCoordinate(Vector3.Cross(delta, impulse), worldInvInertia);
        ...
        public void ApplyNegativeBodyWorldImpulse(ref Vector3 impulse, ref Vector3 delta)
        {
            ...
            #region INLINE: transformRate.AngularVelocity += Vector3.TransformCoordinate(Vector3.Cross(impulse, delta), worldInvInertia);
            float num0, num1, num2;
        ...
        {
            if (immovable) return;
            Vector3.TransformCoordinate(ref impulse, ref transform.Orientation, out impulse);
            Vector3.Multiply(ref impulse,invMass, out impulse);
        ...
        public void ApplyBodyImpulse(Vector3 impulse, Vector3 pos)
        {
            ...
            Vector3.TransformCoordinate(ref impulse, ref transform.Orientation, out impulse);
            Vector3.TransformCoordinate(ref pos, ref transform.Orientation, out pos);
        ...
        {
            if (immovable) return;
            Vector3.TransformCoordinate(ref angImpulse, ref transform.Orientation, out angImpulse);
            Vector3.TransformCoordinate(ref angImpulse, ref worldInvInertia, out angImpulse);
            Vector3.Add(ref transformRate.AngularVelocity, ref angImpulse, out transformRate.AngularVelocity);
            velChanged = true;
        }
        ...
        {
            if (immovable) return;
            Vector3.TransformCoordinate(ref force, ref transform.Orientation, out force);
            Vector3.Add(ref this.force, ref force, out this.force);
            this.velChanged = true;
        }
        ...
        {
            if (immovable) return;
            Vector3.TransformCoordinate(ref torque, ref transform.Orientation, out torque);
            Vector3.Add(ref this.torque, ref torque, out this.torque);
            velChanged = true;
        }
        ...
        {
            Matrix bodyWorld = transform.Orientation * Matrix.Translation(transform.Position);
            Vector3 result;

            Vector3.TransformCoordinate(ref localPosition, ref bodyWorld, out result);
            
            return result;
        }

        public void GetWorldPosition(ref Vector3 localPosition, out Vector3 worldPosition)
        {
            Matrix bodyWorld = transform.Orientation * Matrix.Translation(transform.Position);
            Vector3.TransformCoordinate(ref localPosition, ref bodyWorld, out worldPosition);
        }
    }
}
