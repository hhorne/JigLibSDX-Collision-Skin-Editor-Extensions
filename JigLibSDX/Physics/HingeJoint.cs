    ...
    public class HingeJoint : Joint
    {
        ...
        public override void UpdateController(float dt)
        {
            ...
            if (damping > 0.0f)
            {
                ...
                float angRot1 = Vector3.Dot(body0.transformRate.AngularVelocity, hingeAxis);
                float angRot2 = Vector3.Dot(body1.transformRate.AngularVelocity, hingeAxis);
            ...
            if (extraTorque != 0.0f)
            {
                Vector3 torque1;// = extraTorque * Vector3.TransformCoordinate(hingeAxis, body0.Orientation);
                Vector3.TransformCoordinate(ref hingeAxis, ref body0.transform.Orientation, out torque1);
