...
namespace JigLibSDX.Physics
{
    ...
    public class ConstraintMaxDistance : Constraint
    {
        ...
        public override void PreApply(float dt)
        {
            ...
            #region REFERENCE: R0 = Vector3.TransformCoordinate(body0Pos, body0.Orientation);
            Vector3.TransformCoordinate(ref body0Pos, ref body0.transform.Orientation,out R0);
            #endregion

            #region REFERENCE: R1 = Vector3.TransformCoordinate(body1Pos, body1.Orientation);
            Vector3.TransformCoordinate(ref body1Pos, ref body1.transform.Orientation,out R1);
            #endregion 
        ...
        public override bool Apply(float dt)
        {
            ...
            #region REFERENCE: float denominator = body0.InvMass + body1.InvMass + Vector3.Dot(N, Vector3.Cross(Vector3.TransformCoordinate(Vector3.Cross(R0, N), body0.WorldInvInertia), R0)) + Vector3.Dot(N, Vector3.Cross(Vector3.TransformCoordinate(Vector3.Cross(R1, N), body1.WorldInvInertia), R1));
