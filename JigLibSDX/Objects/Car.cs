...
namespace JigLibSDX.Objects
{
    ...
    public class Car
    {
        ...
        public void SetupDefaultWheels()
        {
            ...
            Vector3 axis = Vector3Helper.Up; // TODO: check this
        ...
        public void PostPhysics(float dt)
        {
            ...
            {
                float dx = (wheels[(int)WheelId.WheelFR].Position.X - wheels[(int)WheelId.WheelBR].Position.X);
                float dy = (wheels[(int)WheelId.WheelFL].Position.Z - wheels[(int)WheelId.WheelFR].Position.Z);
