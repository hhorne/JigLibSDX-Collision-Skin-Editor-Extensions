...
//Released into the JigLibSDX project under the JigLibSDX license.
...
namespace JigLibSDX.Collision
{
    ...
    public class CollisionSystemSAP : CollisionSystem, IComparer<CollisionSkin>
    {
        ...
        public override void DetectCollisions(JigLibSDX.Physics.Body body, CollisionFunctor collisionFunctor, CollisionSkinPredicate2 collisionPredicate, float collTolerance)
        {
            if (!body.IsActive)
                return;
        ...
        public override void DetectAllCollisions(List<JigLibSDX.Physics.Body> bodies, CollisionFunctor collisionFunctor, CollisionSkinPredicate2 collisionPredicate, float collTolerance)
        {
        ...
        public override bool SegmentIntersect(out float fracOut, out CollisionSkin skinOut, out Vector3 posOut, out Vector3 normalOut, JigLibSDX.Geometry.Segment seg, CollisionSkinPredicate1 collisionPredicate)
        {
            ...
            Vector3 max;
            Vector3.Maximize(ref min, ref tmp, out max);
            Vector3.Minimize(ref min, ref tmp, out min);
