...
namespace JigLibSDX.Collision
{
    ...
    public class CollDetectCapsuleCapsule : DetectFunctor
    {
        ...
        public override void CollDetect(CollDetectInfo info, float collTolerance, CollisionFunctor collisionFunctor)
        {
            ...
            Segment oldSeg0 = new Segment(oldCapsule0.Position, oldCapsule0.Length * MatrixHelper.GetBackward(oldCapsule0.Orientation));
            Segment newSeg0 = new Segment(newCapsule0.Position, newCapsule0.Length * MatrixHelper.GetBackward(newCapsule0.Orientation));
            ...
            Segment oldSeg1 = new Segment(oldCapsule1.Position, oldCapsule1.Length * MatrixHelper.GetBackward(oldCapsule1.Orientation));
            Segment newSeg1 = new Segment(newCapsule1.Position, newCapsule1.Length * MatrixHelper.GetBackward(newCapsule1.Orientation));
